...
export default function Credentials() {
  const { apiKey, rotateApiKey, products } = useApp();
  const [showKey, setShowKey] = useState(false);
  const [copied, setCopied] = useState(false);
  const [isRotating, setIsRotating] = useState(false);
  const { toast } = useToast();

  const enabledProducts = products.filter((p) => p.status !== "disabled");
  ...
  const handleRotate = () => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Your new API key is now active. Update your integrations.",
      });
    }, 1000);
  };
  ...
  const handleRevoke = () => {
    toast({
      ...
      description: "Your API key has been revoked. Generate a new one to continue.",
      variant: "destructive",
    });
  };
  ...
  return (
    <DashboardLayout>
      <PageHeader
        ...
        breadcrumbs={[{ label: "API Credentials" }]}
      />

      <div className="space-y-6 max-w-2xl">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Primary API Key</CardTitle>
            <CardDescription>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will immediately revoke your API key. All API access will be
                      disabled until you generate a new key.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancel</AlertDialogCancel>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Your API key provides access to the following products based on
                  your configuration and approval status:
                </p>
